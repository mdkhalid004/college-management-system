...
export class TimetableService {
  ...
  private apiUrl = 'https://college-management-system-2qa4.onrender.com/api/v1/timetable';
  private departmentUrl = 'https://college-management-system-2qa4.onrender.com/api/v1/departments';
  private courseUrl = 'https://college-management-system-2qa4.onrender.com/api/v1/courses';
  private teacherUrl = 'https://college-management-system-2qa4.onrender.com/api/v1/teachers'; 
